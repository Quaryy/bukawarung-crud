...
<head>
	...
	<title>Bukawarung - Edit Produk</title>
...
<main class="main">
	...
	<div class="card">
		<form action="" method="POST" enctype="multipart/form-data">
			...
			<input type="text" name="nama" class="form-input" placeholder="Nama Produk" value="<?php echo $p->product_name ?>" required>
			<input type="text" name="harga" class="form-input" placeholder="Harga" value="<?php echo $p->product_price ?>" required>
			
			<img src="produk/<?php echo $p->product_image ?>" width="100px">
			<input type="hidden" name="foto" value="<?php echo $p->product_image ?>">
			<input type="file" name="gambar" class="form-input">
			<textarea class="form-input" name="deskripsi" placeholder="Deskripsi"><?php echo $p->product_description ?></textarea><br>
